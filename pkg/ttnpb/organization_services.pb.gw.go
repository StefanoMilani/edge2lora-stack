...
var (
	filter_OrganizationAccess_DeleteCollaborator_0 = &utilities.DoubleArray{Encoding: map[string]int{"organization_ids": 0, "organization_id": 1, "collaborator": 2, "user_ids": 3, "user_id": 4}, Base: []int{1, 1, 1, 1, 1, 2, 0, 0}, Check: []int{0, 1, 2, 1, 4, 5, 3, 6}}
)
...
func RegisterOrganizationAccessHandlerServer(ctx context.Context, mux *runtime.ServeMux, server OrganizationAccessServer) error {
	...
	mux.Handle("DELETE", pattern_OrganizationAccess_DeleteAPIKey_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/ttn.lorawan.v3.OrganizationAccess/DeleteAPIKey", runtime.WithHTTPPathPattern("/organizations/{organization_ids.organization_id}/api-keys/{api_key.id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_OrganizationAccess_DeleteCollaborator_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/ttn.lorawan.v3.OrganizationAccess/DeleteCollaborator", runtime.WithHTTPPathPattern("/organizations/{organization_ids.organization_id}/collaborator/user/{collaborator.user_ids.user_id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterOrganizationAccessHandlerClient(ctx context.Context, mux *runtime.ServeMux, client OrganizationAccessClient) error {
	...
	mux.Handle("DELETE", pattern_OrganizationAccess_DeleteAPIKey_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/ttn.lorawan.v3.OrganizationAccess/DeleteAPIKey", runtime.WithHTTPPathPattern("/organizations/{organization_ids.organization_id}/api-keys/{api_key.id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_OrganizationAccess_DeleteCollaborator_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/ttn.lorawan.v3.OrganizationAccess/DeleteCollaborator", runtime.WithHTTPPathPattern("/organizations/{organization_ids.organization_id}/collaborator/user/{collaborator.user_ids.user_id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_OrganizationAccess_DeleteAPIKey_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"organizations", "organization_ids.organization_id", "api-keys", "api_key.id"}, ""))
	...
	pattern_OrganizationAccess_DeleteCollaborator_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"organizations", "organization_ids.organization_id", "collaborator", "user", "collaborator.user_ids.user_id"}, ""))
